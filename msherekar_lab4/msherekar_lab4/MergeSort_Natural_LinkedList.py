...
# Create a  Node so that each data point can be converted into node and then added to linnked list
class Node:
...
# Linked list is either empty or has a value and a link to the next list
empty = None  # empty list


# Create a empty linked list to which nodes can be added
